...
async function theologyAnswer(q: string, route: TheologyRouteKey): Promise<Record<string, unknown>> {
  ...
  let filtered: string;
  if (route === "creation") {
    filtered = "The Bible presents the Earth as created by God in six days (Genesis 1; Exodus 20:11), with genealogies allowing a chronology of thousands of years for human history from Adam. Scripture is primary and does not state or imply deep time.\n\nMainstream science, using radiometric dating of rocks and meteorites, estimates the Earth to be about 4.54 billion years old. This is the consensus view in academia, and it is the web-sourced scientific claim TRU found.\n\nChristians and readers differ on how (or whether) to reconcile the two. Some see the ‘days’ as long periods or frameworks; others take them as ordinary days and question conventional dating assumptions. The text itself remains unchanged.";
